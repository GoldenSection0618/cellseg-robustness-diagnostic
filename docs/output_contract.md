...
results/baselines/sam3_prompted_concept_smoke_metrics.csv
results/baselines/sam3_prompted_concept_clean_subset_metrics.csv
results/robustness/sam3_prompted_concept_full_train_metrics.csv
...
figures/sam3_prompted_concept_full_train_overlay_examples.png
