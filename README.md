...
5. small Otsu-only and three-baseline perturbation smoke tests, a 20-image clean-subset robustness extension, and an Otsu full-train robustness run in `results/robustness/`;
...
2. add Cellpose-SAM / `cpsam` to the staged full-train robustness run;
